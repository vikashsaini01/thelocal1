...
public class FBConnection {
	static final String FB_APP_ID = "1668714276791819";
	static final String FB_APP_SECRET = "685806795c25062b49a7a08089f333c9";
	static final String REDIRECT_URI = "http://localhost:8081/fbhome";

	static String accessToken = "";

	public static final String getFBAuthUrl() {
		String fbLoginUrl = "";
		try {
	...
	private static final String getFBGraphUrl(String code) {
		String fbGraphUrl = "";
		try {
